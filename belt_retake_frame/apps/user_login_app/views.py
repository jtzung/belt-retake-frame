...
def index(request):
    return render(request, 'user_app_login/index.html')
...
def home(request):
    ...
    context = {
        ...
        'user': user,
        'joined' : Trip.objects.filter(joined_by = user)
    }
    return render(request, 'user_app_login/home.html', context)

def addtrip(request):
    
    return render(request, 'user_app_login/add_trip.html')
...
def user(request, trip_id):
    ...
    return render(request, 'user_app_login/user.html', context)

def edit(request, user_id):
    context = {
        'user': User.objects.get(id=user_id)
    }
    return render(request, 'user_app_login/edit.html', context)
